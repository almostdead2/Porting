...
class Extractor(object):
    ...
    def __ext4extractor(self):
        ...
        def scan_dir(root_inode, root_path=""):
            for entry_name, entry_inode_idx, entry_type in root_inode.opendir():
        ...
        with open(self.OUTPUT_IMAGE_FILE, 'rb') as file:
            ...
            dirlist = []
            for file_name, inode_idx, file_type in root.opendir():
    ...
    def checkSignOffset(self, file):
        ...
        if size <= 15728640:
            ...
            mm = mmap.mmap(file.fileno(),15728640 , access=mmap.ACCESS_READ)  # 15728640=15Mb
